...
BOOL params_get_json_string(params_t* params, const char* param_key, const char* json_key, char* json_value, unsigned int json_value_size) {
  const char* str = params_get(params, param_key);
  if(str != NULL && json_value != NULL) {
    jsmn_parser p;
	  //jsmntok_t* ptoken;
    //jsmntok_t* pobject;
    ...
    jsmntok_t *json = jsmn_get_prop_from_obj(tokens, json_key);
    if (json != NULL) {
      jsmn_val2string(json, json_value, json_value_size);
      return TRUE;
    }
...
BOOL params_get_json_int(params_t* params, const char* param_key, const char* json_key, int32_t* value) {
  const char* str = params_get(params, param_key);
  if(str != NULL && value != NULL) {
    jsmn_parser p;
	  //jsmntok_t* ptoken;
...
BOOL params_get_json_double(params_t* params, const char* param_key, const char* json_key, double* value) {
  const char* str = params_get(params, param_key);
  if(str != NULL && value != NULL) {
    jsmn_parser p;
	  //jsmntok_t* ptoken;
