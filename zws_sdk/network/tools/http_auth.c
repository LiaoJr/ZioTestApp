...
int main(int argc, char* argv[]) {
    ...
    const char* device_ids[] = {"12345678"};
    const char* device_types[] = {"invert"};
    ...
    zlg_mqtt_info_err rc = zlg_iot_https_get_mqtt_info(&info, ZLG_IOT_AUTH_HOST, ZLG_IOT_TERMINAL_AUTH_PATH, ZLG_IOT_AUTH_PORT);
